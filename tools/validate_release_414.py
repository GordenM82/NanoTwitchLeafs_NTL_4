...
def main():
    ...
    for marker in ("UpdateEffectControls", "Effect_RadioButton.IsEnabled = !usesUsernameColor", "Effect_ComboBox.IsEnabled = !usesUsernameColor", "Effect_ComboBox.Visibility", "ColorPicker.Visibility"):
